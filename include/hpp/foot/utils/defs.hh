...
template <typename T>
using ConstRefVecTmpl = const Eigen::Ref<const Eigen::Matrix<T, Eigen::Dynamic, 1> >&;
...
typedef const Eigen::Ref<const Eigen::Vector3d>& ConstRefVec3d;

typedef Eigen::Ref<Eigen::Vector4d> RefVec4d;
typedef const Eigen::Ref<const Eigen::Vector4d>& ConstRefVec4d;
