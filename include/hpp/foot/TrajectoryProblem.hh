...
#include <hpp/foot/utils/Box.hh> // done
#include <hpp/foot//utils/FixedPlan.hh> //done
#include <hpp/foot/utils/PlanForHull.hh> //dome
#include <hpp/foot/utils/ProblemConfig.hh> // done
#include <hpp/foot/functions/BoxAbovePlan.hh> // done
#include <hpp/foot/functions/BoxAboveFixedPlan.hh> // done
#include <hpp/foot/functions/CostDistance.hh>  // done
#include <hpp/foot/functions/FixedBoxPosition.hh> //done
